...
*/
	...
	public $content_path 	= 'backend/video';			//set view partial page 
	public $redirect 		= 'VideoCrud';				//set redirect after set flash data
	public $name			= 'Video';					//set insert/update message
	public function set_model(){						//set model name as model
			$this->load->model('Videomodel','model');
	}
/*
|----------------------------------------------------------------------------------------
| Initilize Every Controller 
...
*/
	...
	public function create(){	
		...
		$this->form_validation->set_rules('video_des', 'Description', 'required');
