...
{
	public $site_name 	= 'MTI Trading Ltd.'; 			// _GoToFront_Global method for access globaly
	...
	public function set_flash_redir($condition=null,$success_mess=null,$failed_mess=null){
    	if($condition):
